...
const Page = () => {
  ...
  return (
    <div className="main">
      <div className="nav-container w-full pt-4 h-auto flex flex-row justify-end pr-4 sm:pr-6 lg:pr-10">
        <nav className="relative flex flex-col pr-4 sm:pr-6 lg:pr-10">
          <button
      ...
      <main className="mt-10">
        <h1 className="font-bold text-2xl sm:text-3xl text-center">Dear TDMC,</h1>
        <div className="bg-white content-center p-6 sm:p-8 rounded-lg shadow-lg max-w-lg sm:max-w-2xl lg:max-w-4xl mx-auto my-8">
          <h1 className="text-2xl sm:text-3xl font-bold mb-6">Privacy Policy for Sheet Seeker</h1>
          ...
          <section className="mb-6">
            ...
            <h3 className="text-lg sm:text-xl font-semibold mb-2">Google Drive Files</h3>
            <p className="text-gray-700">
              <strong>File Access</strong>: Sheet Seeker requires access to your Google Drive to function correctly. The application will read through folders of your Google Drive in order to find and select spreadsheets, which will then be used to look for search parameters.
            </p>
          </section>
          ...
          <section className="mb-6">
            <h2 className="text-xl sm:text-2xl font-semibold mb-2">Data Sharing and Disclosure</h2>
            <p className="text-gray-700">
          ...
          <section className="mb-6">
            <h2 className="text-xl sm:text-2xl font-semibold mb-2">User Rights</h2>
            <p className="text-gray-700 mb-4">
          ...
          <section className="mb-6">
            <h2 className="text-xl sm:text-2xl font-semibold mb-2">Changes to This Privacy Policy</h2>
            <p className="text-gray-700">
