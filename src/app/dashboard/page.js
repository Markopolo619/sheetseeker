...
const Page = () => {
  ...
  return (
    <div className="container ">
          ...
          <form className="w-6/12 mt-5">
            <div class="relative">
              ...
              <input
                type="search"
                id="default-search"
                class="aspect-video search-input block w-full h-14 p-4 ps-10 text-sm placeholder-black text-black border-4 border-black rounded-xl outline-none"
      ...
      <div class="mt-16 mx-auto max-w-md"></div>
    </div>
  );
};
