...
export default function Home() {
  ...
  const handleGoogleSignIn = async () => {
    try {
      ...
      if (userDoc.exists()) {
        ...
        setError(
          "User does not exist. Please check your credentials or create an account."
        );
        // Handle the case where the user does not exist in Firestore
        // For example, you could redirect them to a signup page or show an error message
      }
  ...
  return (
    <div className="body">
      <div className="form w-full h- max-w-xs">
        <form
        ...
        <p className="copyright text-center text-gray-500 text-xs">
          {" "}
          {/* Copyright message */}
